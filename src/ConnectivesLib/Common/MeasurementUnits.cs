            ...
            switch (from)
            {
                case AngleUnit.Degree:
                    switch (to)
                    {
                        ...
                        case AngleUnit.Radian:      return Constants.PI / 180.0;
                        case AngleUnit.MilliRadian: return (Constants.PI * 1000.0) / 180.0;
                        default:                    return 0.0;
                    }
                case AngleUnit.Radian:
                    switch (to)
                    {
                        case AngleUnit.Degree:      return 180.0 / Constants.PI;
                        case AngleUnit.Radian:      return 1.0;
                        case AngleUnit.MilliRadian: return 1000.0;
                        default:                    return 0.0;
                    }
            ...
            switch (from)
            {
                case TimeUnit.Nanosecond:
                    switch (to)
                    {
                        ...
                        case TimeUnit.Microsecond: return 1.0 / 1000.0;
                        case TimeUnit.Millisecond: return 1.0 / 1000000.0;
                        case TimeUnit.Second:      return 1.0 / 1000000000.0;
                        case TimeUnit.Minute:      return 1.0 / (1000000000.0 * 60.0);
                        case TimeUnit.Hour:        return 1.0 / (1000000000.0 * 60.0 * 60.0);
                        default:                   return 0.0;
                    }
                case TimeUnit.Microsecond:
                    switch (to)
                    {
                        ...
                        case TimeUnit.Second:      return 1.0 / 1000000.0;
                        case TimeUnit.Minute:      return 1.0 / (1000000.0 * 60.0);
                        case TimeUnit.Hour:        return 1.0 / (1000000.0 * 60.0 + 60.0);
                        default:                   return 0.0;
                    }
                case TimeUnit.Millisecond:
                    switch (to)
                    {
                        case TimeUnit.Nanosecond:  return 1000000.0;
                        case TimeUnit.Microsecond: return 1000.0;
                        case TimeUnit.Millisecond: return 1.0;
                        case TimeUnit.Second:      return 1.0 / 1000.0;
                        case TimeUnit.Minute:      return 1.0 / (1000.0 * 60.0);
                        case TimeUnit.Hour:        return 1.0 / (1000.0 * 60.0 * 60.0);
                        default:                   return 0.0;
                    }
                case TimeUnit.Second:
                    switch (to)
                    {
                        case TimeUnit.Nanosecond:  return 1000000000.0;
                        case TimeUnit.Microsecond: return 1000000.0;
                        case TimeUnit.Millisecond: return 1000.0;
                        case TimeUnit.Second:      return 1.0;
                        case TimeUnit.Minute:      return 1.0 / 60.0;
                        case TimeUnit.Hour:        return 1.0 / (60.0 * 60.0);
                        default:                   return 0.0;
                    }
                case TimeUnit.Minute:
                    switch (to)
                    {
                        case TimeUnit.Nanosecond:  return 60.0 * 1000000000.0;
                        case TimeUnit.Microsecond: return 60.0 * 1000000.0;
                        case TimeUnit.Millisecond: return 60.0 * 1000.0;
                ...
                case TimeUnit.Hour:
                    switch (to)
                    {
                        case TimeUnit.Nanosecond:  return 60.0 * 60.0 * 1000000000.0;
                        case TimeUnit.Microsecond: return 60.0 * 60.0 * 1000000.0;
                        case TimeUnit.Millisecond: return 60.0 * 60.0 * 1000.0;
                        case TimeUnit.Second:      return 60.0 * 60.0;
